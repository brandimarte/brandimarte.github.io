...
The site comes with some default pages with permalinks: topics, publications,
...
shows up in the center of the landing page along with the topics and publications
pages. Note that the topics and publications pages are special, each listing all
...
Each item in your portfolio in the publications category is listed in table format
on the publications page. Each entry includes a work's title, excerpt, date of
